      ...
      <div className="flex justify-between items-start mb-[15px]">
         <div className="bg-[#5B6D8C] w-[823px] h-[504px]">
            ...
            <table className="text-[#FFF] text-[15px] w-full mb-[40px]">
               ...
               >
                  <td className="flex-1 text-center">رپورتاژ</td>
                  <td className="flex-1 text-center">تاریخ پیشنهادی انتشار</td>
                  <td className="flex-1 text-center">وضعیت</td>
                  <td className="flex-1 text-center">عملیات</td>
               </th>
               <tr
                  style={{ borderBottom: '1px solid #6CEFC3' }}
                  className="bg-[#4F5B70] w-full flex h-[41px] items-center"
               >
                  <td className="flex-1 text-center">لورم ایپسوم</td>
                  <td className="flex-1 text-center">لورم ایپسوم</td>
                  <td className="flex-1 text-center">لورم ایپسوم</td>
                  <td className="flex flex-1 text-center justify-center items-center gap-[5px]">
                     <button className="w-[22px] h-[22px] bg-[url(/images/task-icon/edit.svg)] bg-contain bg-no-repeat"></button>
                     <button className="w-[22px] h-[22px] bg-[url(/images/task-icon/trash.svg)] bg-contain bg-no-repeat"></button>
